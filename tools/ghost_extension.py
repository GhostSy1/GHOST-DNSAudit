...
TOOL = "GHOST-DNSAudit"
VERSION = "3.0-PRO"
PROFILE = "DNS zone security and resolver configuration audit"
RULES = [('DNS-DNSSEC', 'DNSSEC|RRSIG|NSEC'), ('DNS-WILDCARD', '\\*\\s+IN\\s+(A|AAAA|CNAME)'), ('DNS-DELEGATION', 'NS\\s+|CNAME\\s+|SOA\\s+')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-DNSAudit v3.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
